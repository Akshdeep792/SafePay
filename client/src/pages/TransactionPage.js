...
const TransactionPage = () => {
    ...
    const onSubmitHandler = (e) => {
        ...
        if (transaction_type === 'bank') {
            if (accountNo.toString().length !== 11) {
                displayAlert("AccountNo Must be of 11 digits")
                return;
            }
    ...
    return (<Wrapper className='full-page'>
        <form className='form' onSubmit={onSubmitHandler}>
            ...
            {transaction_type === 'bank' ? <Input type='number' value={accountNo} name='accountNo' labelText='accountNo(11 digits)' onChange={onChangeHandler} /> : <Input type='number' value={accountNo} name='accountNo' labelText='PhoneNo(10 digits)' onChange={onChangeHandler} />}
            {transaction_type === 'bank' ? <Input type='text' value={upiId} name='upiId' labelText='IFSC Code' onChange={onChangeHandler} /> : <Input type='text' value={upiId} name='upiId' labelText="Enter your upiId" onChange={onChangeHandler} />}
